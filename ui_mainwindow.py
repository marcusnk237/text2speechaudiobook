...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mainToolBar.addSeparator()
        self.mainToolBar.addAction(self.actionConvert)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"PDF to audio", None))
        ...
        self.actionConvert.setToolTip(QCoreApplication.translate("MainWindow", u"Convert to audio", None))
